...
The beneficiary reference uses HMAC-SHA-256 with a secret held outside the database. Contact fields use AES-256-GCM. Operator passwords and OTP challenges use Argon2. Public district aggregates require at least three distinct beneficiaries per district/scheme/source group.
